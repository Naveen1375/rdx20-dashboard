...
with st.sidebar:
    ...
    telemetry_file = st.file_uploader(
        "Telemetry Excel (.xlsx)",
        type=["xlsx"],
        help="Upload your machine telemetry file (data_trial.xlsx)"
    )
    ...
    <div style='display:flex; flex-direction:column; align-items:center;
      ...
      <div style='margin-top:32px; display:flex; gap:20px; justify-content:center; flex-wrap:wrap;'>
        <div style='background:#111827; border:1px solid #1e3a5f; border-radius:10px;
          ...
          <div style='color:#00d4ff; font-weight:600;'>Telemetry Excel</div>
          <div style='color:#64748b; font-size:12px; margin-top:4px;'>data_trial.xlsx</div>
...
def load_telemetry(file_bytes):
    ...
    df.columns = ["Time", "Feed_Rate", "Speed", "Servo_Load", "Cutting_Signal", "Spindle_Load"]
